 ...
 * | `next/crash-view.ts` | the view model — every decision, and everything naming an id, a class or a glyph | `test/crash-view.test.ts`, no DOM |
 ...
 * is a plain value — which works just as well from `next/` as from `lib/`,
