/**
 * The view model behind `next/issues.html`: what rows exist, in what order,
 ...
 * | `next/issues.ts` | the renderer and the interactions | `test/issues-page.test.ts` + the browser run |
 *
 * ## The shared drill-down was considered and **not** used
 *
 * `next/drilldown-view.ts` and `drilldown-render.ts` were extracted for
 * `crashes.html` and `failures.html`, and `next/errors.ts` already judged them
 ...
 * search-box wiring answered once. See `next/issues.ts`.
 *
