 ...
 * booleans" signal the brief names, and `next/errors-view.ts` declined for
 * less.
 *
 ...
 *
 * Enforced the same way as `next/errors-view.ts`: `test/manifests-view.test.ts`
 ...
 * `next/manifests.ts`'s divergence 1.
 */
 ...
 * `next/manifests.ts` divergence 8 — and asserted in
