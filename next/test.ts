 ...
 * | `next/test-view.ts` | the view model — every decision, and everything naming an id, a class or a glyph | `test/test-view.test.ts`, no DOM |
 ...
 * used, and the table is in `next/test-view.ts`'s comment: 775 tests across
